...
const scanTerms = [
  "SCANNING_KORTEX_MODULES",
  "MAPPING_NEURAL_SYNAPSE",
  "TRACING_MEMORY_LEAKS",
  "BUFFER_INTEGRITY_CHECK",
  "ISOLATING_ADVERSARIAL_NODES",
  "DECRYPTING_SENTINEL_LOGS",
  "CAPTURING_TELEMETRY_DATAFRAME",
  "VALIDATING_PROTOCOL_CHAINS"
];
